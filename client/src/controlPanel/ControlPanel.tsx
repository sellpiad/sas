...
export default function ControlPanel({ client }: Props) {
    ...
    useEffect(() => {
        if (direction !== undefined && direction !== ''){
            client?.publish({ destination: '/app/game/action', body: direction })
        }
    }, [direction])
